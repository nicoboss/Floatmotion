...
class glLibLight:
    def __init__(self,pos,camera,color=(255,255,255),diffusecolor=(255,255,255)):
        ...
        if   not glGetBooleanv(GL_LIGHT0): self.light = GL_LIGHT0
        elif not glGetBooleanv(GL_LIGHT1): self.light = GL_LIGHT1
        elif not glGetBooleanv(GL_LIGHT2): self.light = GL_LIGHT2
        elif not glGetBooleanv(GL_LIGHT3): self.light = GL_LIGHT3
        elif not glGetBooleanv(GL_LIGHT4): self.light = GL_LIGHT4
        elif not glGetBooleanv(GL_LIGHT5): self.light = GL_LIGHT5
        elif not glGetBooleanv(GL_LIGHT6): self.light = GL_LIGHT6
        elif not glGetBooleanv(GL_LIGHT7): self.light = GL_LIGHT7
        else: self.can_be_represented = False
        camera.set_camera()
